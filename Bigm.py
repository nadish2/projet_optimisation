...
class Expr:
    ...
    def __init__(self, name, id, maxi, cx1, cx2, cx3, cz, op, cb):
        self.name = name
        self.id = id
        self.maxi=maxi #1 si maximisation 0 sinon
        self.cz = cz
...
# Z = Expr("Z", 0, 1, 11, 16, 15, 1, 3,0 )
# print("------------------------------------------------------------------------------------")

# # Expression de c1
# print("Expression de la première contrainte A:")
# A = Expr("A", 1, 1, 1, 2 , 1.5, 0, 1, 12000 )
# print(A.op)
...
# B = Expr("B", 2, 1, 0.666, 0.666, 1, 0, 1,4600)
# print(B.op)
...
# C = Expr("C", 3, 1, 0.5, 0.333, 0.5, 0, 1, 2400)
# print(C.op)
